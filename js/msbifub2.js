 ...
 ******************************************************/
 ...
 // Public ical.s
const CALENDARS = {
  S7_ANGLAIS: 'afknoo88ub36mtigskd7onm8ek',
  S7_APU: 'dalb6rcjq1l5uonp99ipsbefb0',
  S7_BSTATS: 'hnt79pepoc3a9omjvmlkmdrl88',
  S7_IMAJS: '3h2brkfagdb5lmo0bc60h9qaqs',
  S7_OBI: 'jg2ut49067j7rus68c76tgspl0',
  S8_ALGOPRG2: '2pg06m2oe4nshusb294ftpjo9s',
  S8_BBP: 'gj4b6s72vaimkf9eajjcnolabg',
  S8_BDD: 'bf3ejtmu8f3da58u5l5jbrd0kg',
  S8_BIODIV: '7c4sd4ssq3epfb55ghuv7qnqqs',
  S8_CPRD: 'np2j4gfmuo312d7icgv0vlpebc',
  S8_ECOAQUA: '6v268abbjemtcvqlo1ob4rb7f8',
  S8_ECOTERR: 'sfs6ajp1ricdcgh9h4plvnv2vk',
  S8_GENEPI: '21jtg3m4afkpok2v5ba5okhucs',
  S8_NGS: 'pjmnuq9oam9nnsfabds17buu00',
  S8_POO: 's7n0fpslbb7cfo0af7oh6812qk',
  S8_WEBMOD: '3e0o55fc11p2pp4lcob720ng3c',
  S9_FILBI: 'None',
  S9_GLOG: 'None',
  S9_STRUBIGL: 'None',
  S10_STAGE: 'None',
...
function initCalendar() {
    ...
    const semesters = (cal.dataset.month < 8) ? ['S8', 'S1'] : ['S7','S9'];
    console.log(semesters);
    
    // Load M1 events
    const ueids = Object.keys(CALENDARS).filter( c => semesters.includes(c.substring(0,2)) );
    console.log(ueids);
    for (let id of ueids) {
      console.log(id);
      loadCalendarICS(id);
...
function loadCalendarICS(ueID) {
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState == 4 && (xhr.status == 200 || xhr.status == 0)) {
            let data = parse_ics(xhr.responseText);
            // Merge events...
            Object.assign(calendar_data,data); // ECMAScript 2015
            updateCalendar();
        }
    };
    const path = 'https://calendar.google.com/calendar/ical/';
    const extension = '%40group.calendar.google.com/public/basic.ics';
    xhr.open("GET", `${path}${CALENDARS[ueID]}${extension}`, true);
    xhr.send(null);
}
...
function updateCalendarBody(y,m,d) {
    ...
    var masterTrack = parseInt(localStorage.masterTrack) || 1; // Default track: C++Bio=1; GenEco=2
